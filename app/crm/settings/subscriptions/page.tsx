...
// Advisor-only: /crm is already gated to advisors by the CRM layout.
export default function CrmSubscriptionsCatalogPage() {
    ...
    >
      <div className="mx-auto max-w-3xl">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-verdant-ink">קטלוג מנויים מערכתי</h1>
            <p className="mt-1 text-sm text-verdant-muted">
              בתי עסק שנחשבים מנוי עבור כל הלקוחות. עסקה חדשה מבית עסק שכאן תזוהה
              אוטומטית כמנוי — אלא אם ללקוח יש החלטה אישית הפוכה.
            </p>
          </div>
          <Link
            href="/crm/settings"
