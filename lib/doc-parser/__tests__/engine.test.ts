...
assert("וולט → מזון",           categorize("wolt delivery").key, "food");
...
assert("קולנוע → פנאי",         categorize("yes planet קולנוע").key, "leisure");
assert("מסעדה → פנאי",          categorize("מסעדה יפנית").key, "leisure");
...
const recurTx: ParsedTransaction[] = [
  ...
  { date: "2024-01-15", description: "Netflix", amount: 49.9, category: "leisure", categoryLabel: "פנאי" },
  { date: "2024-02-15", description: "Netflix", amount: 49.9, category: "leisure", categoryLabel: "פנאי" },
  { date: "2024-03-15", description: "Netflix", amount: 49.9, category: "leisure", categoryLabel: "פנאי" },
  // Arnona — same amount, day 1
  { date: "2024-01-01", description: "ארנונה ת\"א", amount: 450, category: "housing", categoryLabel: "דיור" },
  { date: "2024-02-01", description: "ארנונה ת\"א", amount: 450, category: "housing", categoryLabel: "דיור" },
  { date: "2024-03-01", description: "ארנונה ת\"א", amount: 450, category: "housing", categoryLabel: "דיור" },
  // Random one-time
  { date: "2024-02-20", description: "איקאה", amount: 850, category: "shopping", categoryLabel: "קניות" },
];
...
assert("Arnona recurring amount", groups.find(g => g.description.includes("ארנונה"))?.amount, 450);

console.log("\n═══ 10. Burn Rate Analysis ═══");
const burnTx: ParsedTransaction[] = [
  // Jan: income 15000, expenses 10000
  { date: "2024-01-05", description: "משכורת", amount: -15000, category: "salary", categoryLabel: "משכורת" },
  { date: "2024-01-10", description: "שופרסל", amount: 3000, category: "food", categoryLabel: "מזון" },
  { date: "2024-01-15", description: "ארנונה", amount: 2000, category: "housing", categoryLabel: "דיור" },
  { date: "2024-01-20", description: "חשמל", amount: 5000, category: "utilities", categoryLabel: "שוטפים" },
  // Feb: income 15000, expenses 10000
  { date: "2024-02-05", description: "משכורת", amount: -15000, category: "salary", categoryLabel: "משכורת" },
  { date: "2024-02-10", description: "שופרסל", amount: 3000, category: "food", categoryLabel: "מזון" },
  { date: "2024-02-15", description: "ארנונה", amount: 2000, category: "housing", categoryLabel: "דיור" },
  { date: "2024-02-20", description: "חשמל", amount: 5000, category: "utilities", categoryLabel: "שוטפים" },
  // Mar: income 15000, expenses 12500 (+25% spike)
  { date: "2024-03-05", description: "משכורת", amount: -15000, category: "salary", categoryLabel: "משכורת" },
  { date: "2024-03-10", description: "שופרסל", amount: 4000, category: "food", categoryLabel: "מזון" },
  { date: "2024-03-15", description: "ארנונה", amount: 2000, category: "housing", categoryLabel: "דיור" },
  { date: "2024-03-20", description: "חשמל", amount: 6500, category: "utilities", categoryLabel: "שוטפים" },
];
