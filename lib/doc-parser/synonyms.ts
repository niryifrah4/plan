...
const SYNONYM_MAP: Record<CanonicalField, string[]> = {
  date: [
    ...
    "ת.עסקה", "ת.חיוב", "תאריך העסקה", "תאריך הפעולה",
    "תאריך רכישה", "תאריך קנייה", "תאריך ביצוע",
    // Leumi specific
    "תאריך ביצוע הפעולה", "ת.ביצוע",
    // Discount specific
    "ת. ערך", "ת.ערך",
    // Mizrahi specific
    "תאריך תנועה",
    // Credit card dates
    "מועד חיוב", "מועד העסקה", "מועד רכישה",
    // English
    "date", "trans date", "value date", "transaction date", "posting date",
  ],
  description: [
    // Hebrew — all bank variants.
    ...
    "תיאור הפעולה", "פירוט הפעולה",
    "שם העסק", "שם עסק", "בית עסק", "שם בעל העסק",
    // Leumi specific
    "פעולה/אסמכתא", "תאור", "פרטי התנועה",
    // Leumi HTML format
    "תיאור התנועה",
    // Hapoalim HTML format
    "סוג תנועה", "סוג התנועה",
    // Mercantile / older Hapoalim
    "הפעולה",
    // Discount specific — combo column "פירוט/אסמכתא" IS a description
    "פירוט/אסמכתא",
    // Credit card specific
    "שם בית העסק/פירוט", "שם ביה\"ע", "שם בית-עסק",
    "מקום הרכישה", "שם סוחר",
    // Mercantile
    "תאור הפעולה",
    // English
  ...
  debit: [
    ...
    "משיכות", "חובה / משיכות",
    // Mizrahi specific
    "סכום התנועה", "סכום פעולה",
    // Credit card specific
    "סכום חיוב ש\"ח", "סכום חיוב בשח", "סכום עסקה בשח",
    "סכום עסקה", "סכום לחיוב בש\"ח", "סה\"כ בש\"ח",
    "סכום בשקלים חדשים", "סכום עסקה בש\"ח",
    // Isracard
    "סכום חיוב", "סכום החיוב",
    // Cal / Visa Cal
    "סכום לתשלום",
    // Max (Leumi Card)
    "סכום בש\"ח",
    // English
    "debit", "charge", "amount", "withdrawal",
  ],
  credit: [
    // Hebrew — all bank variants
...
const CREDIT_CARD_HINTS: [string, string[]][] = [
  ...
  ["מקס",             ["-max", "max בהצדעה", "max-", "transaction-details_export_max", "leumi card", "לאומי קארד"]],
