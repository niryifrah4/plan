...
const starter: WorkbookData = {
  ...
  goals: rows(["שנת הבסיס", "קרן חירום", "רכישת דירה / שדרוג דירה", "לימודים לילדים", "חתונה / עזרה לילדים", "החלפת רכב", "טיול משפחתי גדול", "שיפוץ הבית", "חופש כלכלי", "שנת יעד", "עלות היום", "עלות עתידית", "תשואה ברוטו", "דמי ניהול", "תשואה נטו", "צריך היום — חד-פעמי", "יש כבר ₪", "חסר", "להפקיד כל חודש", "מקצים בפועל ₪", "פער", "הערות"], "g").map((row) => ({ ...row, note: "זהה למבנה עמוד מטרות ויעדים באקסל" })),
