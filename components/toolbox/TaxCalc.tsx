...
export function TaxCalc() {
  ...
  const totalMonthlyDeductions = incomeTax.tax / 12 + bituachLeumi.monthly;
    ...
    <div className="space-y-6">
      ...
      <div className="v-card p-5">
        ...
        <div className="rounded-xl p-4 space-y-3" style={{ background: "#f4f7ed" }}>
          ...
          <Row label="מס הכנסה שנתי" value={fmtILS(incomeTax.tax)} color="#b91c1c" />
          <Row label="שיעור מס אפקטיבי" value={fmtPct(incomeTax.effectiveRate * 100)} />
          ...
          <div className="border-t pt-2" style={{ borderColor: "#d8e0d0" }}>
            <Row label="נטו חודשי (אומדן)" value={fmtILS(netMonthly)} bold color="#0a7a4a" />
          </div>
        </div>
      </div>
      ...
      <div className="v-card p-5">
        ...
        <div className="rounded-xl p-4 space-y-3" style={{ background: "#f4f7ed" }}>
          ...
          <Row label="נטו לאחר מס" value={fmtILS(cgt.netAfterTax)} bold color="#0a7a4a" />
        </div>
      </div>
    </div>
  );
